 ...
 * `paid/whatsapp/lib/whatsapp/dispatch.ts` once `journalForNumber` has already found the
 ...
 * Nothing sets it but `paid/whatsapp/lib/whatsapp/proposalExecution.ts`, and only after
