...
export const JOURNAL_TOOLS: readonly Tool[] = [
  ...
  {
    /**
     * B1022 — `sessionsOf` already answered exactly what a list needs; it had
     * no caller. Each option carries the session id as `value`. B2171 took
     * away the `href` into the chat room, which is retired: the block still
     * lists them for the model, and nothing links anywhere.
     */
