 ...
 * along with the caution-banner shades `yellow-50`, `yellow-100` and
 * `yellow-900` added the same way for B1810. Everything else in `palette()`
 * stays literal across both themes.
 */
