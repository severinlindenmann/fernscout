 ...
 * `render.ts` drew SVG for the website and `paid/photobook/lib/photobook/travellers.ts` drew
 ...
 * - `paid/photobook/lib/photobook/travellers.ts` → PDF operators, flipping y on the way
 *
