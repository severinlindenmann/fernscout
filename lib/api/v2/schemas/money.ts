...
// mirrors.
import { z } from "zod";
import { BUYER_METHODS, CREDIT_STEP, MAX_CREDITS, MIN_CREDITS } from "@paid/credits/lib/credits/pricing";
...
/** `PaymentStatus` in `paid/credits/lib/payments.ts`, restated here because that module is
