import type { DayWhatsappOutcome } from "@paid/whatsapp/lib/digest/dayWhatsapp";
 ...
 *
 * The request body is read elsewhere, once, by `paid/whatsapp/lib/api/publishFlags.ts`.
 */
