...
- **Standortverlauf**, nur bei einem Journal, dessen Besitzerin ihn dort
  abgelegt hat: eine importierte Datei (ein Google- oder GPX-Export) oder
  Positionen, die die iPhone-App während einer Reise aufgezeichnet hat, für
  die sie die Aufzeichnung eingeschaltet hat — für jede Reise gefragt, auf dem
  Telefon bestätigt und einen Tag nach Reiseende von selbst beendet, ausser sie
  lässt sie bewusst weiterlaufen. Er geht nur an den eigenen Server dieses
  Journals, an niemanden sonst. Leserinnen und Leser sehen ihn nie: Die Karte
  einer Reise zeigt eine daraus gezeichnete Linie nur für Tage, die sie ohnehin
  lesen dürfen, nichts aus den letzten 24 Stunden und nie die ersten oder
  letzten 500 Meter einer Strecke; als privat markierte Orte werden
  herausgeschnitten. Nur der Besitzerin selbst kann der Name des Ortes
  vorgeschlagen werden, an dem sie einen Tag verbracht hat, und sie kann den
  Verlauf auf der Standortseite des Studios löschen, monatsweise oder ganz.
  Die App funktioniert auch ohne Standortzugriff vollständig.
...
| **Anthropic PBC** (USA) | Jemand nutzt die Schreibhilfe über WhatsApp — um einen Tag schreiben zu lassen, Fotos beschriften zu lassen oder einen getippten oder gesprochenen Satz verstehen zu lassen | Was die Person getippt oder gesagt hat; die Angaben, die ihr eigener Tag ohnehin trägt (Datum, Ort, Land sowie Anzahl und Zeitspanne der Fotos); und für Bildunterschriften die Fotos selbst |
...
**Ein Link nach draussen ist kein Dienst in dieser Liste, und beim Link zu
Google Maps gehört das gesagt.** Unter der Karte einer Reise steht „In Google
Maps öffnen". Das ist ein gewöhnlicher Link: Er trägt die Koordinaten des
ausgewählten Ortes und sonst nichts, und er öffnet Google Maps in einem neuen
Tab. Solange niemand ihn anklickt, geht an Google nichts — keine Kachel, kein
Skript, keine Anfrage. Es ist keine eingebettete Karte, und Google erfährt
nicht, dass es diese Seite gibt.

Wer ihn anklickt, ist danach auf Googles Seite und nicht mehr auf dieser. Dort
gelten [Googles Datenschutzerklärung](https://policies.google.com/privacy) und
Googles Bedingungen, Google sieht die IP-Adresse und was ein Aufruf seiner
Seite sonst mit sich bringt, und darauf hat dieser Betreiber weder Einfluss
noch Einsicht — er erfährt auch nicht, dass jemand geklickt hat. **Für die
Inhalte fremder Seiten und für das, was dort mit Ihnen geschieht, wird keine
Haftung übernommen.** Das gilt für diesen Link wie für jeden anderen Link, der
von hier wegführt.
...
niemand die Schreibhilfe über WhatsApp benutzt.** Ein Journal zu
...
keine Leserin und kein Agent erreicht — gelesen wird daraus nur der Ortsname,
der der Besitzerin selbst beim Schreiben eines neuen Tages vorgeschlagen wird —,
und er gehört nicht zu den Angaben, die die Schreibhilfe bekommt.
