    ...
    >
      <div className="relative mx-auto flex max-w-3xl flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:order-2">
          {/* `/welcome` — B2170, was `/?start=1` (B1905), which only signed
              in: a stranger on a demo journal owns nothing yet. `/welcome`
              makes the journal, and says so plainly where signup is off. */}
          <Link
            href="/welcome"
