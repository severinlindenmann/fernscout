  ...
  return (
    <div className={bare ? "" : "mt-3"}>
      ...
      {/* Where the thing that is not a photograph has gone — B845. Said only
          ...
          screen holding twelve photographs is noise. Only on the general
          picker (B2082): a studio import that narrows `accept` to its own
          file reads that file itself, and "read it into the trip from your
          inbox" would send the person somewhere else to do it. */}
      {kinds.files > 0 && accept === PICKER_ACCEPT && (
