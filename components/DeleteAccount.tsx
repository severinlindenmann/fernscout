 ...
 *
 * **Pressing the coral confirm button deletes nothing**, and the copy says so twice:
...
export default function DeleteAccount({
  ...
  username: string;
  /** B2023: the hub tile pressed is the first press, so the inventory
   *  question opens at once; `onClose` is what its cancel does. */
  open?: boolean;
  onClose?: () => void;
}) {
  const { t } = useI18n();
