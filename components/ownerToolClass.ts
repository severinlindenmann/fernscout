...
export const OWNER_TOOL =
  "flex min-h-11 w-full grow items-center rounded-lg border border-line-quiet bg-surface-raised px-3 py-2 text-left text-xs font-semibold leading-5 text-ink-strong transition-colors hover:border-line-prominent disabled:opacity-60";
