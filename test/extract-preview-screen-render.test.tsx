 ...
 * harness as `paid/test/extract-credits-screen.test.tsx`.
 *
...
describe("the preview screen", () => {
  ...
  test("a finished day gets a hero and a strip of its own real photographs — B1803 Task 1.3", async () => {
    ...
    expect(hero!.querySelector("img")?.getAttribute("src")).toBe("/api/helper/alex/studio/thumb/run-1/p1");
