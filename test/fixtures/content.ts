...
export type DayFixture = {
  ...
  /** `"draft"` withholds the day; absent means published — the same default
   * `lib/entries.ts` reads. `"published"` is accepted too, and means exactly
   * what omitting it means: a fixture that wants to say so out loud should be
   * able to, rather than encoding it as a blank (2026-09-19). */
