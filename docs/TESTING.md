...
| **B5** | Click the trip name in the header | The trip switcher lists all four journeys |
...
| **B11** | `/example/trips` | All **four** trips, grouped current / past, each with a day count, a country count and a photo count that are **not 0** |
| **B12** | The lifetime map on that page | Four routes, four different colours in the legend |
...
The four trips deliberately spend in **CHF, EUR, THB, VND and USD**.
