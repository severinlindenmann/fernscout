...
| [B622](backlog/small-feature/B622-an-agent-cannot-rename-a-trip.md) | An agent cannot rename a trip or move its dates, though the owner's own page now can | FEATURE | medium | low |
...
| --- | --- | --- | --- | --- | --- |
| [B621](in-development/B621-the-owner-s-own-details-sit.md) | The owner's own details sit on the wrong page, and a trip's title and dates cannot be changed by anybody | FEATURE | high | high | `46b8aec7` |
