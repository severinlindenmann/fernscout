...
| [B1785](backlog/issue/B1785-the-documented-way-to-get-an.md) | The documented way to get an agent token for any journal works only for the journal the admin address owns | ISSUE | medium | low |
