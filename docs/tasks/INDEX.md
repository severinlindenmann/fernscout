...
| [B939](backlog/issue/B939-a-pressed-proposal-is-invisible-to.md) | A pressed proposal is invisible to the conversation that proposed it | ISSUE | high | medium |
...
| [B941](backlog/issue/B941-correcting-a-sentence-is-read-as.md) | Correcting a sentence is read as adding a cost | ISSUE | medium | low |
...
| --- | --- | --- | --- | --- | --- |
| [B940](in-development/B940-a-trip-the-journal-does-not.md) | A trip the journal does not have is silently answered with the one it does | ISSUE | high | low | `fdfcf5f2` |
