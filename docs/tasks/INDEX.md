...
| [B1090](in-development/B1090-a-day-s-zone-must-be.md) | A day's zone must be worked out from where it happened, or B42 helps almost no day that exists | ISSUE | high | medium | `eef381a2` |
...
| [B1084](in-development/B1084-nothing-refreshes-the-ecb-rates-on.md) | Nothing refreshes the ECB rates on a deployed instance, so a costs page converts at whatever rate the last deploy happened to carry | ISSUE | medium | low | `f88144a1` |
| [B1085](in-development/B1085-the-nightly-backup-mails-on-success.md) | The nightly backup mails on success, so the operator's answer to did it work is a mailbox rather than a page | FEATURE | medium | low | `f88144a1` |
