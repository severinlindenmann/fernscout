...
| --- | --- | --- | --- | --- | --- |
| [B920](in-development/B920-the-helper-says-it-saved-something.md) | The helper says it saved something when it called no tool | ISSUE | high | medium | `fdfcf5f2` |
| [B924](in-development/B924-a-note-written-for-the-model.md) | A note written for the model is printed to the person | ISSUE | high | low | `fdfcf5f2` |
| [B925](in-development/B925-attaching-the-files-you-ticked-fails.md) | Attaching the files you ticked fails with unknown day | ISSUE | high | low | `fdfcf5f2` |
| [B927](in-development/B927-the-helper-invents-a-trip-id.md) | The helper invents a trip id instead of using the one it just made | ISSUE | high | low | `fdfcf5f2` |
