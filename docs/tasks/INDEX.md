...
| [B965](backlog/issue/B965-a-name-that-fits-two-trips.md) | A name that fits two trips picks the newer one and says nothing | ISSUE | medium | low |
...
| [B964](in-development/B964-the-model-narrates-its-own-tool.md) | The model narrates its own tool confusion to the person | ISSUE | medium | low | `fdfcf5f2` |
