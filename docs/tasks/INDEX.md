...
| --- | --- | --- | --- | --- | --- |
| [B942](in-development/B942-pressing-a-proposal-to-set-a.md) | Pressing a proposal to set a day's words with an empty box erases them | ISSUE | high | low | `fdfcf5f2` |
