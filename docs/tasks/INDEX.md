...
| --- | --- | --- | --- | --- | --- |
| [B671](in-development/B671-an-agent-cannot-import-location-history.md) | An agent cannot import location history, because the only way in is a shell on the server | FEATURE | high | high | `1d31e523` |
