...
| [B1354](backlog/small-feature/B1354-a-deleted-journal-s-name-can.md) | A deleted journal's name can only be freed with a shell on the server | FEATURE | medium | low |
