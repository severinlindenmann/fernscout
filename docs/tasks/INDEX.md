...
| --- | --- | --- | --- | --- | --- |
| [B776](in-development/B776-an-agent-token-can-mint-itself.md) | An agent token can mint itself a fresh token forever without the owner ever seeing a code | SECURITY | high | medium | `41335894` |
