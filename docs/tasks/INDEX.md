...
| # | Finding | Type | Priority | Complexity |
| --- | --- | --- | --- | --- |
| [B966](backlog/docs-and-skills/B966-nothing-tells-a-new-agent-that.md) | Nothing tells a new agent that the honesty net exists or why it is shaped that way | DOCS | medium | low |
