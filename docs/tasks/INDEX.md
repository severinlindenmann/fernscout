...
| --- | --- | --- | --- | --- | --- |
| [B608](in-development/B608-the-file-shape-a-journal-must.md) | The file shape a journal must have is not published anywhere | FEATURE | high | medium | `ac8af30e` |
| [B609](in-development/B609-the-helper-copies-the-file-shape.md) | The helper copies the file shape instead of reading it from the instance | FEATURE | high | medium | `ac8af30e` |
| [B612](in-development/B612-the-agent-guide-teaches-photographs-without.md) | The agent guide teaches photographs without saying one can be held back | DOCS | high | low | `0959df30` |
...
| [B607](in-development/B607-a-config-patch-reports-credits-as.md) | A config PATCH reports credits as off on a server that has it on | ISSUE | low | low | `302202e0` |
