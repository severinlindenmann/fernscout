...
| [B943](backlog/issue/B943-the-sentence-that-replaces-a-false.md) | The sentence that replaces a false claim is itself a claim, and it can be false | ISSUE | high | low |
...
| [B938](backlog/issue/B938-an-approved-reader-is-sent-a.md) | An approved reader is sent a link that does not let her in | ISSUE | medium | low |
...
| --- | --- | --- | --- | --- | --- |
| [B942](in-development/B942-pressing-a-proposal-to-set-a.md) | A proposal to set a day's words opens on an empty box no press can accept | ISSUE | high | low | `fdfcf5f2` |
...
| [B941](in-development/B941-correcting-a-sentence-is-read-as.md) | Correcting a sentence is read as adding a cost | ISSUE | medium | low | `fdfcf5f2` |
