...
| [B682](backlog/big-feature/B682-a-day-cannot-be-written-from.md) | A day cannot be written from a phone without an agent | FEATURE | high | high |
...
| [B681](backlog/small-feature/B681-a-person-without-an-agent-has.md) | A person without an agent has nowhere to start | FEATURE | high | medium |
...
| --- | --- | --- | --- | --- | --- |
| [B691](in-development/B691-an-importer-can-pass-its-own.md) | An importer can pass its own contract check and still have the money upside down | ISSUE | high | medium | `1d31e523` |
| [B692](in-development/B692-api-health-advertises-video-formats-on.md) | /api/health advertises video formats on a server that cannot take a clip | ISSUE | high | low | `d7d9b2c7` |
...
| [B690](in-development/B690-post-api-v1-user-import-dryrun.md) | POST /api/v1/<user>/import: dryRun flag on costs import has no effect and response does not say so | ISSUE | medium | low | `1d31e523` |
| [B693](in-development/B693-the-runbook-provisions-a-server-without.md) | The runbook provisions a server without ffmpeg, and the deploy never mentions it | DOCS | medium | low | `d7d9b2c7` |
