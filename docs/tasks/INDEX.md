...
| [B669](backlog/issue/B669-video-is-served-without-range-support.md) | Video is served without Range support, so a clip cannot be scrubbed | ISSUE | high | low |
...
| [B670](backlog/issue/B670-kept-in-the-media-upload-response.md) | kept in the media upload response omits the video originals it stored | ISSUE | low | low |
