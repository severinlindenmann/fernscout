...
| [B890](backlog/small-feature/B890-search-indexes-only-days-and-four.md) | Search indexes only days and four nav rows — trips, docs pages and journal destinations are unfindable | FEATURE | medium | medium |
