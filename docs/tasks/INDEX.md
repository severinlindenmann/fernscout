...
| [B676](backlog/issue/B676-the-urls-door-refuses-video-fetchimage.md) | The urls door refuses video: fetchImage takes only image/* content types | ISSUE | medium | low |
...
| [B604](in-development/B604-uploading-the-same-photograph-twice-lands.md) | Uploading the same photograph twice lands it twice, and nothing can tell | ISSUE | medium | medium | `d7d9b2c7` |
| [B677](in-development/B677-a-bank-statement-can-only-be.md) | A bank statement can only be read on the owner's own laptop, so the parsing lives in the helper | FEATURE | medium | high | `1d31e523` |
