...
| [B960](backlog/issue/B960-money-in-another-currency-is-dropped.md) | Money in another currency is dropped from the total and nothing says so | ISSUE | high | medium |
...
| --- | --- | --- | --- | --- | --- |
| [B959](in-development/B959-the-trip-total-is-read-as.md) | The trip total is read as a stranger, so money on a draft day is invisible to its own owner | ISSUE | high | low | `fdfcf5f2` |
| [B961](in-development/B961-press-to-save-is-not-one.md) | Press to save is not one of the ways of saying press | ISSUE | high | low | `fdfcf5f2` |
