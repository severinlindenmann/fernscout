...
| # | Finding | Type | Priority | Complexity |
| --- | --- | --- | --- | --- |
| [B821](open/B821-credits-and-storage-are-buried-on.md) | Credits and storage are buried on the account page with everything else | FEATURE | medium | medium |
...
| [B823](open/B823-search-finds-days-and-never-the.md) | Search finds days and never the pages, so there is no way to search your way to costs or storage | FEATURE | medium | medium |
| [B824](open/B824-the-agent-and-docs-sit-apart.md) | The agent and docs sit apart from the destinations they are listed with | ISSUE | medium | low |
| [B825](open/B825-the-landing-page-corner-offers-the.md) | The landing page corner offers the operator a way in and everybody else nothing | FEATURE | medium | low |
