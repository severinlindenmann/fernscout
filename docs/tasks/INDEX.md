...
| [B1105](in-development/B1105-the-operator-s-personal-mobile-number.md) | The operator's personal mobile number is the example in the source, the public API spec and the agent guide | SECURITY | high | low | `8aa24275` |
...
| # | Finding | Type | Priority | Complexity | Held by |
| --- | --- | --- | --- | --- | --- |
| [B1086](testing/security/B1086-anonymous-export-zip-hands-out-the.md) | Anonymous export.zip hands out the owner's name, email and home town | SECURITY | high | low | — |
...
| [B1084](testing/issue/B1084-nothing-refreshes-the-ecb-rates-on.md) | Nothing refreshes the ECB rates on a deployed instance, so a costs page converts at whatever rate the last deploy happened to carry | ISSUE | medium | low | — |
...
| [B1088](testing/issue/B1088-trace-returns-http-500-instead-of.md) | TRACE returns HTTP 500 instead of 405 on pages and API | ISSUE | low | low | — |
| [B1089](testing/issue/B1089-x-powered-by-header-advertises-next.md) | x-powered-by header advertises Next.js to anonymous callers | ISSUE | low | low | — |
...
| [B1078](testing/small-feature/B1078-a-trip-s-title-dates-visibility.md) | A trip's title, dates, visibility, people and tracks cannot be changed from the conversation | FEATURE | medium | medium | — |
| [B1079](testing/small-feature/B1079-a-trip-s-exchange-rates-and.md) | A trip's exchange rates and planned budget cannot be set from the conversation | FEATURE | medium | medium | — |
| [B1080](testing/small-feature/B1080-invites-telling-readers-about-a-day.md) | Invites, telling readers about a day, and the send channels are unreachable from the conversation | FEATURE | medium | medium | — |
| [B1081](testing/small-feature/B1081-the-journal-s-own-title-storage.md) | The journal's own title, storage, keys and past conversations are unreachable from the conversation | FEATURE | medium | medium | — |
| [B1082](testing/small-feature/B1082-postcards-and-photobooks-are-unreachable-from.md) | Postcards and photobooks are unreachable from the conversation | FEATURE | medium | medium | — |
| [B1083](testing/small-feature/B1083-the-inbox-and-taking-a-photograph.md) | The inbox, and taking a photograph back off a day, are unreachable from the conversation | FEATURE | medium | medium | — |
| [B1085](testing/small-feature/B1085-the-nightly-backup-mails-on-success.md) | The nightly backup mails on success, so the operator's answer to did it work is a mailbox rather than a page | FEATURE | medium | low | — |
| [B1103](testing/small-feature/B1103-nothing-can-tell-an-agent-which.md) | Nothing can tell an agent which photographs on a trip are the same picture twice | FEATURE | medium | low | — |
...
| # | Finding | Type | Priority | Complexity | Held by |
| --- | --- | --- | --- | --- | --- |
| [B1097](testing/chore/B1097-an-agent-judges-a-page-from.md) | An agent judges a page from its own reading of the code, because there is no instrument that shows it the page | CHORE | high | medium | — |
...
| # | Finding | Type | Priority | Complexity | Held by |
| --- | --- | --- | --- | --- | --- |
| [B1099](testing/docs-and-skills/B1099-every-decision-a-run-needs-is.md) | Every decision a run needs is asked mid-run, so a batch cannot be started and left alone | DOCS | high | high | — |
| [B1100](testing/docs-and-skills/B1100-nothing-carries-a-batch-of-approved.md) | Nothing carries a batch of approved tickets through build, merge, deploy and live check without a person driving each step | DOCS | high | high | — |
...
| [B1101](testing/docs-and-skills/B1101-a-run-s-report-draws-its.md) | A run's report draws its before-and-after from the diff, and triage hands back a list nobody can paste into an agent | DOCS | medium | low | — |
