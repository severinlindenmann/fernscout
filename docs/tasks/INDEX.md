...
| # | Finding | Type | Priority | Complexity |
| --- | --- | --- | --- | --- |
| [B280](open/B280-an-invite-link-cannot-be-handed.md) | An invite link cannot be handed out a second time, because the token is only stored hashed | SECURITY | medium | medium |
