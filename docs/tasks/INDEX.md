...
| [B1084](backlog/issue/B1084-nothing-refreshes-the-ecb-rates-on.md) | Nothing refreshes the ECB rates on a deployed instance, so a costs page converts at whatever rate the last deploy happened to carry | ISSUE | medium | low |
...
| [B1085](backlog/small-feature/B1085-the-nightly-backup-mails-on-success.md) | The nightly backup mails on success, so the operator's answer to did it work is a mailbox rather than a page | FEATURE | medium | low |
