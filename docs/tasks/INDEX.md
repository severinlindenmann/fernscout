...
| [B667](in-development/B667-the-importer-folder-is-flat-so.md) | The importer folder is flat, so it only ever describes one kind of data | CHORE | medium | low | `1d31e523` |
| [B668](in-development/B668-five-confirmations-arrive-as-browser-dialogs.md) | Five confirmations arrive as browser dialogs rather than as the page | ISSUE | medium | low | `52155fa5` |
