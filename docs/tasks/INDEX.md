...
| # | Finding | Type | Priority | Complexity |
| --- | --- | --- | --- | --- |
| [B26](in-development/B26-the-welcome-mail-is-english-only.md) | The welcome mail is English only, and nobody is asked which language the journal is in | FEATURE | medium | low |
