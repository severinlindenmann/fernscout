...
| # | Finding | Type | Priority | Complexity |
| --- | --- | --- | --- | --- |
| [B40](in-development/B40-a-six-digit-code-expires-in.md) | A six-digit code expires in ten minutes, which is shorter than people take to find the mail | CHORE | medium | low |
