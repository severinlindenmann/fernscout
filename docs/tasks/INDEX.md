...
| # | Finding | Type | Priority | Complexity |
| --- | --- | --- | --- | --- |
| [B83](open/B83-a-trip-md-the-reader-cannot.md) | A trip.md the reader cannot parse is dropped silently, so a broken trip and no trip look the same | ISSUE | high | low |
