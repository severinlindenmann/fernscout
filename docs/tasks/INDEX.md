...
| [B690](backlog/issue/B690-post-api-v1-user-import-dryrun.md) | POST /api/v1/<user>/import: dryRun flag on costs import has no effect and response does not say so | ISSUE | medium | low |
...
| [B676](in-development/B676-the-urls-door-refuses-video-fetchimage.md) | The urls door refuses video: fetchImage takes only image/* content types | ISSUE | medium | low | `d7d9b2c7` |
