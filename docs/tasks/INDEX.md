...
| [B872](backlog/issue/B872-any-photograph-with-no-left-to.md) | Any photograph with no left-to-right contrast is silently dropped as a duplicate | ISSUE | high | low |
...
| [B868](backlog/issue/B868-the-chips-in-the-menu-panel.md) | The chips in the menu panel hide their labels to fit a header row they no longer sit in | ISSUE | medium | low |
