...
repository renders (the balance on `/<user>/studio/account`, the ledger).
...
- The balance shown to the owner (`/<user>/studio/account`) matches the
  ledger before and after, at the requested viewport (graphical check).
