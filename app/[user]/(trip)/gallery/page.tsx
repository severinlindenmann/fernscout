...
export default async function GalleryPage({
  ...
  // draft visibility three lines up, and `paid/postcard/lib/postcard/entry.ts` explains why
  // the two questions must not sit in one file. `paid/photobook/lib/photobook/entry.ts` is
