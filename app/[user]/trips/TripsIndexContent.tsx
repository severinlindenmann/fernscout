 ...
 *
 * `ownerName` (B278) travels on the `owner: false` branch: it is a fact
 * about the *journal*, computed once in `page.tsx` from `config.json`, and constant
