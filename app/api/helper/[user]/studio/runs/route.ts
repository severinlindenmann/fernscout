 ...
 * actually resumed — `GET .../studio/run`'s own `extendOnTouch` call,
 ...
 * 0 days left to tell" — debris from `POST .../studio/start` calls that
 ...
 * full 48 hours otherwise, so a person who opens `/studio/photos` a few times
...
export async function GET(
  request: Request,
  { params }: RouteContext<"/api/helper/[user]/studio/runs">,
) {
